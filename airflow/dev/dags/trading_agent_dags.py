...
The actual DAG definitions are in: /workspace/trading-agent/src/_airflow_dags_
...
try:
    ...
    dag_file_path = "/workspace/trading-agent/src/_airflow_dags_/edgar_master_idx_dag.py"
...
try:
    import importlib.util
    # Use actual DAG file path (workspace or fallback location)
    dag_file_path = "/workspace/trading-agent/src/_airflow_dags_/edgar_filings_quarterly_dag.py"
    if not os.path.exists(dag_file_path):
        # Fallback: try workspace location
...
try:
    import importlib.util
    # Use actual DAG file path (workspace or fallback location)
    dag_file_path = "/workspace/trading-agent/src/_airflow_dags_/edgar_company_tickers_dag.py"
    if not os.path.exists(dag_file_path):
        # Fallback: try workspace location
...
try:
    import importlib.util
    # Use actual DAG file path (workspace or fallback location)
    dag_file_path = "/workspace/trading-agent/src/_airflow_dags_/edgar_filings_dag.py"
    if not os.path.exists(dag_file_path):
        # Fallback: try workspace location
