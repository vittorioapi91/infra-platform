...
echo "   MLflow dev:   http://localhost:55000"
echo "   MLflow test:  http://localhost:55001"
echo "   MLflow prod:  http://localhost:55002"
echo "   Airflow DEV:  http://localhost:8082   (admin/2014) - for dev/* branches"
echo "   Airflow TEST: http://localhost:8083   (admin/2014) - for test env"
echo "   Airflow PROD: http://localhost:8084   (admin/2014) - for main branch"
echo "   Postgres:     via nginx ports 54321–54326 (postgres.{env}.{agent}.local.info, see gateway/README)"
